...
const login = () => {
    ...
    axios.post('http://localhost:8080/WebShopAppREST/rest/login/login', { username: username.value, password: password.value })
        .then(response => {
            if(response.data.username == null){
                success.value = 'Korisnik je neuspesno prijavljen.';
